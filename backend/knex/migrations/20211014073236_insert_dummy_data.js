    ...
    return await knex('branch').insert(
        ...
        await knex('theme').insert(
            [
                ...
                {active: true, branch_id:1, title: '루시드 드리머', content: '깊은 잠에서 깨어난 그 곳은 바로 나의 꿈 속이었다.', difficulty: 3.5, length: 60, device_importance: 10, image_path:'/images'},
                {active: true, branch_id:1, title: '콜드 케이지', content: '꿈 속에서 이어지는 발자취를 따라 최종적으로 도착한 이 곳은..?', difficulty: 2, length: 60, device_importance: 50, image_path:'/images'},
                ...
                {active: true, branch_id:3, title: '튀어 마르시', content: '사랑하난 나의 그대 마르시. 지금 이 곳에서 당장 도망쳐야해..! 튀어 마르시!!', difficulty: 4.5, length: 75, device_importance: 80, image_path:'/images'},
                {active: true, branch_id:3, title: '향수', content: '어디선가 나는 악취를 따라간 그 곳에는...', difficulty: 5, length: 70, device_importance: 0, image_path:'/images'},
                {active: true, branch_id:4, title: '플라이 투 더 스카이', content: '이태리에서 돌아온 성환이 교환과 재회한다.', difficulty: 1, length: 60, device_importance: 20, image_path:'/images'}
            ]
        ).then(async function(){
                ...
                await knex('cost').insert(
                    ...
                    await knex('time_table').insert(
                        [
                            ...
                            {theme_id: 4, start_time: '09:00', end_time: '10:00'},
                            {theme_id: 4, start_time: '11:00', end_time: '12:00'},
                            {theme_id: 4, start_time: '13:00', end_time: '14:00'},
                            {theme_id: 4, start_time: '15:00', end_time: '16:00'},
                            {theme_id: 4, start_time: '17:00', end_time: '18:00'},
                            {theme_id: 4, start_time: '19:00', end_time: '20:00'},
                            {theme_id: 4, start_time: '21:00', end_time: '22:00'},
                            ...
                            {theme_id: 6, start_time: '09:00', end_time: '10:00'},
                            {theme_id: 6, start_time: '11:00', end_time: '12:00'},
                            {theme_id: 6, start_time: '13:00', end_time: '14:00'},
                            {theme_id: 6, start_time: '15:00', end_time: '16:00'},
                            {theme_id: 6, start_time: '17:00', end_time: '18:00'},
                            {theme_id: 6, start_time: '19:00', end_time: '20:00'},
                            {theme_id: 6, start_time: '21:00', end_time: '22:00'},
                            {theme_id: 7, start_time: '09:00', end_time: '10:00'},
                            {theme_id: 7, start_time: '11:00', end_time: '12:00'},
                            {theme_id: 7, start_time: '13:00', end_time: '14:00'},
                            {theme_id: 7, start_time: '15:00', end_time: '16:00'},
                            {theme_id: 7, start_time: '17:00', end_time: '18:00'},
                            {theme_id: 7, start_time: '19:00', end_time: '20:00'},
                            {theme_id: 7, start_time: '21:00', end_time: '22:00'},
