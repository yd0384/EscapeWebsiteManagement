...
export default {
    ...
    mounted() {
        this.form.cost.push({number_of_player: 2, price: 0});
        this.form.cost.push({number_of_player: 3, price: 0});
        this.form.cost.push({number_of_player: 4, price: 0});
